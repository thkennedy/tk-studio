...
- AD-16 porting the tk-council migration safety rules verbatim (closed inventory, no-delete-before-clearance, copy-verify-flag) is the strongest single AD in the document.
