...
New subsystem #1 — no legacy-council precedent. **Build order (Tim's ruling, 2026-07-25): local-first.** The default in-repo backends ship and stabilize before any external backend, making local development easy; migration local → online is designed to be straightforward.
