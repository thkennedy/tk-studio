...
`dps-council/` holds a full working copy of the DPS council marketplace repo
(`DirtyPearlStudios/claude-plugins`, main @ `d26a67f`) used as the design model
...
repo, not a rehome of dps-council.
...
Note: the token-suffix leak flagged in the dps-council eval
(`shared-memory/dps-agent-orchestrator/`) was scrubbed in this copy on
2026-07-26.
