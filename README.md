...
`tk-council/` holds a gitignored working copy of the pre-studio TK council marketplace repo used as tk-studio's design model. It keeps its own `.git/` for local reference and is never committed here.
